            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-gray-400">Upload dan kelola video untuk streaming</p>
                    </div>
                    <div>
                        <input
                            type="file"
                        ...
                        <button
                            ...
                            disabled={uploading}
                            className="px-5 py-2.5 bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-purple-600 disabled:from-gray-600 disabled:to-gray-700 text-white rounded-lg font-medium transition-all flex items-center gap-2 relative overflow-hidden"
                        >
                            {uploading ? (
                                <>
                ...
                {loading ? (
                    ...
                    <div className="glass-panel rounded-xl p-12 text-center">
                        ...
                        <p className="text-gray-500 mb-6">Upload video pertamamu untuk memulai streaming</p>
                        <button
                            onClick={() => fileInputRef.current?.click()}
                            className="px-6 py-3 bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-purple-600 text-white rounded-lg font-medium transition-all"
                        >
